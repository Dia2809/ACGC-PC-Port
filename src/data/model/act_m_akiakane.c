...
#ifdef TARGET_PC
static u16 act_m_akiakane_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
static u8 act_m_akiakane[0x180];
#else
...
#ifdef TARGET_PC
static Vtx act_m_akiakane_v[0x120 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_model_act_m_akiakane_c(void) {
    pc_load_asset("assets/act_m_akiakane/act_m_akiakane_pal.bin", act_m_akiakane_pal, 0x20, 0xB49410, 0, 1);
    pc_load_asset("assets/act_m_akiakane/act_m_akiakane.bin", act_m_akiakane, 0x180, 0xB49430, 0, 0);
    pc_load_asset("assets/act_m_akiakane/act_m_akiakane_v.bin", act_m_akiakane_v, 0x120, 0xB492F0, 0, 2);
}
#endif
