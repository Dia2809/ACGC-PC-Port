...
void _pc_load_src_data_model_act_m_ginyanma_c(void) {
    pc_load_asset("assets/act_m_ginyanma/act_m_ginyanma_pal.bin", act_m_ginyanma_pal, 0x20, 0xB4AF20, 0, 1);
    pc_load_asset("assets/act_m_ginyanma/act_m_ginyanma.bin", act_m_ginyanma, 0x180, 0xB4AF40, 0, 0);
    pc_load_asset("assets/act_m_ginyanma/act_m_ginyanma_v.bin", act_m_ginyanma_v, 0x120, 0xB4AE00, 0, 2);
}
#endif
