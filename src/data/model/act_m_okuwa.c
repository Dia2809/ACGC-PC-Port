...
#ifdef TARGET_PC
static u16 act_m_okuwa_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
static Vtx act_m_okuwa_v[0xC0 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_model_act_m_okuwa_c(void) {
    pc_load_asset("assets/act_m_okuwa/act_m_okuwa_pal.bin", act_m_okuwa_pal, 0x20, 0xB53980, 0, 1);
    pc_load_asset("assets/act_m_okuwa/act_m_okuwa.bin", act_m_okuwa, 0x200, 0xB539A0, 0, 0);
    pc_load_asset("assets/act_m_okuwa/act_m_okuwa_v.bin", act_m_okuwa_v, 0xC0, 0xB538C0, 0, 2);
}
#endif
