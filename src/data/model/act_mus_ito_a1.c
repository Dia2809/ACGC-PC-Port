...
#ifdef TARGET_PC
static u16 int_sum_ito_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
Vtx act_mus_ito_a1_v[0x4E0 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_model_act_mus_ito_a1_c(void) {
    pc_load_asset("assets/act_mus_ito_a1/int_sum_ito_pal.bin", int_sum_ito_pal, 0x20, 0xCE4B00, 0, 1);
}
#endif
