...
#ifdef TARGET_PC
static u16 int_sum_iwana_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 act_mus_iwana_body_txt[0x300];
#else
...
#ifdef TARGET_PC
Vtx act_mus_iwana_a1_v[0x400 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_model_act_mus_iwana_a1_c(void) {
    pc_load_asset("assets/act_mus_iwana_a1/int_sum_iwana_pal.bin", int_sum_iwana_pal, 0x20, 0xCE5900, 0, 1);
}
#endif
