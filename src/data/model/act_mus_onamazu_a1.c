...
#ifdef TARGET_PC
static u16 int_sum_oonamazu_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 act_mus_oonamazu_body_txt[0x400];
#else
...
#ifdef TARGET_PC
Vtx act_mus_onamazu_a1_v[0x5A0 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_model_act_mus_onamazu_a1_c(void) {
    pc_load_asset("assets/act_mus_onamazu_a1/int_sum_oonamazu_pal.bin", int_sum_oonamazu_pal, 0x20, 0xD16EC0, 0, 1);
}
#endif
