...
#ifdef TARGET_PC
static u16 int_sum_pirania_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 act_mus_pirania_body_txt[0x200];
#else
...
#ifdef TARGET_PC
Vtx act_mus_pirania_a1_v[0x380 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_model_act_mus_pirania_a1_c(void) {
    pc_load_asset("assets/act_mus_pirania_a1/int_sum_pirania_pal.bin", int_sum_pirania_pal, 0x20, 0xD19AC0, 0, 1);
}
#endif
