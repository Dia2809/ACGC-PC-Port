...
#ifdef TARGET_PC
static u16 int_tak_cone02_asi_tex_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
u8 int_tak_cone01_asi_tex[0x80];
#else
...
#ifdef TARGET_PC
u8 int_tak_cone01_body_tex[0x100];
#else
...
#ifdef TARGET_PC
u8 int_tak_cone01_top_tex[0x80];
#else
...
#ifdef TARGET_PC
Vtx int_tak_cone01_v[0x200 / sizeof(Vtx)];
#else
