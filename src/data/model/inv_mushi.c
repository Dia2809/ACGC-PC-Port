...
#ifdef TARGET_PC
u16 inv_mushi_nuno_tex_rgb_ci4_pal[0x20 / sizeof(u16)] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
static u16 inv_mushi_w5_tex_rgb_ci4_pal[0x20 / sizeof(u16)];
#else
...
#ifdef TARGET_PC
u8 inv_mwin_shirushi1_tex[0x200];
#else
...
#ifdef TARGET_PC
u8 inv_mushi_nuno_tex_rgb_ci4[0x200];
#else
...
#ifdef TARGET_PC
Vtx inv_mushi_v[0x920 / sizeof(Vtx)];
#else
Vtx inv_mushi_v[] = {
...
void _pc_load_src_data_model_inv_mushi_c(void) {
    pc_load_asset("assets/inv_mushi/inv_mushi_w5_tex_rgb_ci4_pal.bin", inv_mushi_w5_tex_rgb_ci4_pal, 0x20, 0x71C0C0, 0, 1);
    pc_load_asset("assets/inv_mushi/inv_mushi_w1_tex_rgb_ci4_pal.bin", inv_mushi_w1_tex_rgb_ci4_pal, 0x20, 0x71C100, 0, 1);
    pc_load_asset("assets/inv_mushi/inv_mushi_w2_tex_rgb_ci4_pal.bin", inv_mushi_w2_tex_rgb_ci4_pal, 0x20, 0x71C120, 0, 1);
    pc_load_asset("assets/inv_mushi/inv_mushi_w3_tex_rgb_ci4_pal.bin", inv_mushi_w3_tex_rgb_ci4_pal, 0x20, 0x71C140, 0, 1);
    pc_load_asset("assets/inv_mushi/inv_mushi_w4_tex_rgb_ci4_pal.bin", inv_mushi_w4_tex_rgb_ci4_pal, 0x20, 0x71C160, 0, 1);
    pc_load_asset("assets/inv_mushi/inv_mushi_w6_tex_rgb_ci4_pal.bin", inv_mushi_w6_tex_rgb_ci4_pal, 0x20, 0x71C180, 0, 1);
    pc_load_asset("assets/inv_mushi/inv_mushi_w7_tex_rgb_ci4_pal.bin", inv_mushi_w7_tex_rgb_ci4_pal, 0x20, 0x71C1A0, 0, 1);
    pc_load_asset("assets/inv_mushi/inv_mwin_nwaku_tex.bin", inv_mwin_nwaku_tex, 0x400, 0x7982E0, 0, 0);
    pc_load_asset("assets/inv_mushi/inv_mwin_shirushi_tex.bin", inv_mwin_shirushi_tex, 0x400, 0x71C7C0, 0, 0);
