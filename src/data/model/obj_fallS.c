...
Gfx obj_fallS_grpAT_model[] = {
    ...
    gsSPVertex(obj_fallS_v, 9, 0),
    gsSPNTrianglesInit_5b(4, 0, 1, 2, 3, 4, 1, 5, 2, 6),
    gsSPNTriangles_5b(7, 6, 8, 0, 0, 0, 0, 0, 0, 0, 0, 0),
    gsSPEndDisplayList(),
};

Gfx obj_fallS_grpBT_model[] = {
...
Gfx obj_fallS_grpDT_model[] = {
    ...
    gsSPVertex(&obj_fallS_v[23], 7, 0),
    gsSPNTrianglesInit_5b(5, 0, 1, 2, 0, 2, 3, 1, 4, 2),
    gsSPNTriangles_5b(4, 5, 2, 1, 6, 4, 0, 0, 0, 0, 0, 0),
    gsSPEndDisplayList(),
};

Gfx obj_fallS_grpCT_model[] = {
    ...
    gsSPVertex(&obj_fallS_v[30], 10, 0),
...
Gfx obj_fallS_rainbowT_model[] = {
    ...
    gsSPVertex(&obj_fallS_v[40], 32, 0),
    ...
    gsSPVertex(&obj_fallS_v[72], 13, 0),
...
Gfx obj_fallS_model[] = {
    ...
    gsSPDisplayList(obj_fallS_grpAT_model),
    gsSPDisplayList(obj_fallS_grpBT_model),
    gsSPDisplayList(obj_fallS_grpCT_model),
    gsSPDisplayList(obj_fallS_grpDT_model),
    gsSPEndDisplayList(),
};

EVW_ANIME_SCROLL obj_fallS_evw_anime_1[] = { { 0, 0, 32, 32 }, { 0, 2, 16, 16 } };

EVW_ANIME_SCROLL obj_fallS_evw_anime_2[] = { { 0, -3, 32, 32 }, { 0, -8, 32, 32 } };

EVW_ANIME_SCROLL obj_fallS_evw_anime_3[] = { { 0, -8, 32, 32 }, { 0, 0, 32, 32 } };

EVW_ANIME_SCROLL obj_fallS_evw_anime_4[] = { { -1, 1, 32, 32 }, { 0, 0, 16, 16 } };

EVW_ANIME_DATA obj_fallS_evw_anime[] = { { 1, EVW_ANIME_TYPE_SCROLL2, obj_fallS_evw_anime_1 },
