...
void _pc_load_src_data_model_obj_fallSE_c(void) {
    pc_load_asset("assets/obj_fallSE/obj_fall_rainbow_1_tex_rgb_rgba16.bin", obj_fall_rainbow_1_tex_rgb_rgba16, 0x100, 0x801920, 0, 0);
    pc_load_asset("assets/obj_fallSE/obj_fall_rainbowA_tex_rgb_i4.bin", obj_fall_rainbowA_tex_rgb_i4, 0x80, 0x801A20, 0, 0);
    pc_load_asset("assets/obj_fallSE/obj_fallCA1_tex_rgb_ia8.bin", obj_fallCA1_tex_rgb_ia8, 0x400, 0x801AA0, 0, 0);
    pc_load_asset("assets/obj_fallSE/obj_fallA2_tex_rgb_i4.bin", obj_fallA2_tex_rgb_i4, 0x200, 0x801EA0, 0, 0);
    pc_load_asset("assets/obj_fallSE/obj_fallA3_tex_rgb_i4.bin", obj_fallA3_tex_rgb_i4, 0x80, 0x8020A0, 0, 0);
    pc_load_asset("assets/obj_fallSE/obj_fallC2_tex_rgb_i4.bin", obj_fallC2_tex_rgb_i4, 0x200, 0x802120, 0, 0);
    pc_load_asset("assets/obj_fallSE/obj_fallC3_tex_rgb_i4.bin", obj_fallC3_tex_rgb_i4, 0x80, 0x802320, 0, 0);
}
#endif
