...
#include "assets/obj_item_apple2/obj_item_apple_pal.inc"
};
#endif

#ifdef TARGET_PC
static u8 obj_item_apple_tex[0x200];
#else
static u8 obj_item_apple_tex[] = {
#include "assets/obj_item_apple2/obj_item_apple_tex.inc"
};
#endif
...
#include "assets/obj_item_apple2/obj_item_apple_v.inc"
};
#endif
...
Gfx apple_DL_mode[] = {
    ...
    gsDPLoadTLUT_Dolphin(15, 16, 1, obj_item_apple_pal),
    gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 32, obj_item_apple_tex),
...
Gfx apple_DL_vtx[] = {
    gsSPVertex(obj_item_apple_v, 4, 0),
