...
#ifdef TARGET_PC
Vtx obj_pstump3_shadow_v[0x40 / sizeof(Vtx)];
#else
...
void _pc_load_src_data_model_obj_pstump3_c(void) {
    pc_load_asset("assets/obj_pstump3/obj_pstump_shadow_tex.bin", obj_pstump_shadow_tex, 0x200, 0x3E44A0, 0, 0);
}
#endif
