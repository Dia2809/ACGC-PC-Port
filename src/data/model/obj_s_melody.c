...
#ifdef TARGET_PC
u8 obj_s_melody_tex[0x800] ATTRIBUTE_ALIGN(32);
#else
...
#ifdef TARGET_PC
Vtx obj_s_melody_v[0x80 / sizeof(Vtx)];
#else
Vtx obj_s_melody_v[] = {
...
void _pc_load_src_data_model_obj_s_melody_c(void) {
    pc_load_asset("assets/obj_s_melody/obj_melody_pal.bin", obj_melody_pal, 0x20, 0x3F2DA0, 0, 1);
}
#endif
