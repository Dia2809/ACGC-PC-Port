...
#ifdef TARGET_PC
Vtx obj_s_pstump4_v[0x70 / sizeof(Vtx)];
#else
Vtx obj_s_pstump4_v[] = {
...
void _pc_load_src_data_model_obj_s_pstump4_c(void) {
    pc_load_asset("assets/obj_s_pstump4/obj_s_palm_stump_tex.bin", obj_s_palm_stump_tex, 0x400, 0x3EA380, 0, 0);
}
#endif
