...
#include "assets/obj_shop_kaza5/tol_kaza_5_pal.inc"
};
#endif
...
#include "assets/obj_shop_kaza5/tol_kaza_5_a_tex_txt.inc"
};
#endif
...
#include "assets/obj_shop_kaza5/tol_kaza_5_c_tex_txt.inc"
};
#endif
...
#include "assets/obj_shop_kaza5/tol_kaza_5_b_tex_txt.inc"
};
#endif

#ifdef TARGET_PC
Vtx obj_shop_kaza5_v[0x360 / sizeof(Vtx)];
#else
Vtx obj_shop_kaza5_v[] = {
#include "assets/obj_shop_kaza5_v.inc"
};
#endif

Gfx obj_shop_kaza5_model[] = {
...
gsSPVertex(obj_shop_kaza5_v, 24, 0),
...
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_CLAMP, GX_CLAMP, 0, 0),
gsSPVertex(&obj_shop_kaza5_v[24], 30, 0),
...
void _pc_load_src_data_model_obj_shop_kaza5_c(void) {
    pc_load_asset("assets/obj_shop_kaza5/tol_kaza_5_pal.bin", tol_kaza_5_pal, 0x20, 0x66F5E0, 0, 1);
    pc_load_asset("assets/obj_shop_kaza5/tol_kaza_5_a_tex_txt.bin", tol_kaza_5_a_tex_txt, 0x200, 0x66F600, 0, 0);
    pc_load_asset("assets/obj_shop_kaza5/tol_kaza_5_c_tex_txt.bin", tol_kaza_5_c_tex_txt, 0x200, 0x66F800, 0, 0);
    pc_load_asset("assets/obj_shop_kaza5/tol_kaza_5_b_tex_txt.bin", tol_kaza_5_b_tex_txt, 0x100, 0x66FA00, 0, 0);
}
#endif
