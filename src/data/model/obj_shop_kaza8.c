...
#include "assets/obj_shop_kaza8/tol_kaza_8_pal.inc"
};
#endif
...
#include "assets/obj_shop_kaza8/tol_kaza_8_d_tex_txt.inc"
};
#endif
...
#include "assets/obj_shop_kaza8/tol_kaza_8_a_tex_txt.inc"
};
#endif
...
#include "assets/obj_shop_kaza8/tol_kaza_8_c_tex_txt.inc"
};
#endif
...
#include "assets/obj_shop_kaza8/tol_kaza_8_e_tex_txt.inc"
};
#endif
...
#include "assets/obj_shop_kaza8/tol_kaza_8_b_tex_txt.inc"
};
#endif

#ifdef TARGET_PC
Vtx obj_shop_kaza8_v[0x7E0 / sizeof(Vtx)];
#else
Vtx obj_shop_kaza8_v[] = {
#include "assets/obj_shop_kaza8_v.inc"
};
#endif

Gfx obj_shop_kaza8_model[] = {
...
gsSPVertex(obj_shop_kaza8_v, 24, 0),
...
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_CLAMP, GX_CLAMP, 0, 0),
gsSPVertex(&obj_shop_kaza8_v[24], 28, 0),
...
gsSPVertex(&obj_shop_kaza8_v[52], 8, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 0, 3, 1, 0, 0, 0),
...
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_CLAMP, GX_CLAMP, 0, 0),
gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
gsSPVertex(&obj_shop_kaza8_v[60], 24, 0),
...
gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 32, 32, tol_kaza_8_c_tex_txt),
gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_CLAMP, GX_CLAMP, 0, 0),
gsSPVertex(&obj_shop_kaza8_v[84], 28, 0),
...
gsSPNTrianglesInit_5b(2, 20, 21, 22, 20, 23, 21, 0, 0, 0),
gsSPNTrianglesInit_5b(2, 24, 25, 26, 24, 27, 25, 0, 0, 0),
gsSPVertex(&obj_shop_kaza8_v[112], 14, 0),
gsSPNTrianglesInit_5b(2, 0, 1, 2, 0, 3, 1, 0, 0, 0),
