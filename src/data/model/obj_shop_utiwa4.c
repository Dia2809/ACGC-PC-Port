...
void _pc_load_src_data_model_obj_shop_utiwa4_c(void) {
    pc_load_asset("assets/obj_shop_utiwa4/tol_fan4_pal.bin", tol_fan4_pal, 0x20, 0x679CC0, 0, 1);
    pc_load_asset("assets/obj_shop_utiwa4/tol_fan4_tex_txt.bin", tol_fan4_tex_txt, 0x400, 0x679CE0, 0, 0);
}
#endif
