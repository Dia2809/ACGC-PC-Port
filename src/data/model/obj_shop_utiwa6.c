...
#include "assets/obj_shop_utiwa6/tol_fan6_pal.inc"
};
#endif
...
#include "assets/obj_shop_utiwa6/tol_fan6_tex_txt.inc"
};
#endif

#ifdef TARGET_PC
Vtx obj_shop_utiwa6_v[0x80 / sizeof(Vtx)];
#else
Vtx obj_shop_utiwa6_v[] = {
#include "assets/obj_shop_utiwa6_v.inc"
};
#endif

Gfx obj_shop_utiwa6_mat_model[] = {
...
Gfx obj_shop_utiwa6_gfx_model[] = {
gsSPVertex(obj_shop_utiwa6_v, 8, 0),
