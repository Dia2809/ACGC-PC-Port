...
#ifdef TARGET_PC
Vtx obj_w_palm2_v[0x70 / sizeof(Vtx)];
#else
Vtx obj_w_palm2_v[] = {
...
void _pc_load_src_data_model_obj_w_palm2_c(void) {
    pc_load_asset("assets/obj_w_palm2/obj_w_palm_young_tex.bin", obj_w_palm_young_tex, 0x800, 0x3F8EA0, 0, 0);
}
#endif
