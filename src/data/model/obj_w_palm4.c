...
void _pc_load_src_data_model_obj_w_palm4_c(void) {
    pc_load_asset("assets/obj_w_palm4/obj_w_palm_leaf_tex.bin", obj_w_palm_leaf_tex, 0x800, 0x3F7100, 0, 0);
    pc_load_asset("assets/obj_w_palm4/obj_w_palm_trunk_tex.bin", obj_w_palm_trunk_tex, 0x800, 0x3F7900, 0, 0);
}
#endif
