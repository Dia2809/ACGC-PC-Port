...
void _pc_load_src_data_model_rom_myhome1_wall_c(void) {
    pc_load_asset("assets/rom_myhome1_wall/rom_myhome_pal.bin", rom_myhome_pal, 0x20, 0xBB86C0, 0, 1);
    pc_load_asset("assets/rom_myhome1_wall/rom_myhome_window_tex.bin", rom_myhome_window_tex, 0x200, 0x59D7A0, 0, 0);
    pc_load_asset("assets/rom_myhome1_wall/rom_myhome_enter2_tex.bin", rom_myhome_enter2_tex, 0x800, 0x59F5C0, 0, 0);
}
#endif
